...
Config.nameJob                    = "Enexis Techniek"
Config.nameJobLabel               = "Enexis"
Config.platePrefix                = "Techniek"
Config.Locale                     = 'en'

Config.Vehicles = {
	Truck = {
		Spawner = 1,
		Label = 'Techniek of Stroom',
		Hash = "boxville",
		Livery = 0,
		Trailer = "none",
	}	
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = 'Techniek of Stroom',
	hint = 'Druk op ~INPUT_CONTEXT~ om in het menu van de Kleedkamer te komen',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Druk op ~INPUT_CONTEXT~ om een voertuig te kiezen',
  },
  ...
  VehicleDeleter = {
	...
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Zet voertuig terug",
	hint = 'Druk op ~INPUT_CONTEXT~ om het voertuig in de garage te zetten',
  },
  ...
  Vente = {
	...
	Color = {r = 0, g = 255, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Baan uitbetalen",
	...
	ItemDrop = 100,
	ItemPrice  = 800,
	hint = 'Druk op ~INPUT_CONTEXT~ om uw stadcheques te verzilveren',
  },
