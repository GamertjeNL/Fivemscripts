...
RegisterServerEvent('esx_mcdonalds:getPaid')
    AddEventHandler('esx_mcdonalds:getPaid', function(amount)
    local xPlayer = ESX.GetPlayerFromID(source)
    xPlayer.addMoney(math.floor(amount))
end)

RegisterServerEvent('esx_mcdonalds:payDeposit')
    AddEventHandler('esx_mcdonalds:getDeposit', function(amount)
    local xPlayer = ESX.GetPlayerFromID(source)
    xPlayer.removeMoney(math.floor(amount))
end)

RegisterServerEvent('esx_mcdonalds:addItem')
    AddEventHandler('esx_mcdonalds:addItem', function(item)
    local xPlayer = ESX.GetPlayerFromID(source)
    xPlayer.addInventoryItem(item, 1)
end) 

RegisterServerEvent('esx_mcdonalds:removeItem')
    AddEventHandler('esx_mcdonalds:removeItem', function(item)
    local xPlayer = ESX.GetPlayerFromID(source)
...
ESX.RegisterUsableItem('mcdonalds_drink', function(source)
	...
	xPlayer.showNotification("~b~Je hebt een ~y~McDonalds~b~ drankje gedronken.")
end)
...
ESX.RegisterUsableItem('mcdonalds_fries', function(source)
	...
	xPlayer.showNotification("~b~Je hebt wat ~y~McDonalds~b~ Frietjes gegeten.")
end)
...
ESX.RegisterUsableItem('mcdonalds_burger', function(source)
	...
	TriggerClientEvent('esx_basicneeds:onEat', source)
	xPlayer.showNotification("~b~Je hebt een ~y~McDonalds~b~ Burger gegeten.")
end)
...
ESX.RegisterUsableItem('mcdonalds_meal', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'thirst', 200000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	xPlayer.showNotification("~b~Je at en dronk een ~y~McDonalds~b~ Maaltijd.")
end)
