config = {}
----- General
Config.Locale = 'en' -- Niet aanzitten!!!

-- Settings
-- Jobs
Config.EnablePlayerJobs = true -- Zet de baan aan voor spelers.
Config.EnablePlayerCook = true -- Maak drinken, maak Burgers en friet
Config.EnablePlayerClerk = true -- Hun bestelling opnemen en maak het en geef het aan de klant
Config.EnablePlayerDriver = true -- Rij naar een plek voor een bestelling

Config.EnableNPCWorkers = false -- Laat NPC Alles doen (Zet dit wel uit als Player jobs aan staat).
Config.EnableNPCOrders = true 

Config.CookJobPay = 50 -- Hoeveel je betaalt als je een maaltijd maakt.
Config.CashJobPay = 40 -- Hoeveel iemand wordt betaalt als hij een maaltijd naar een tafel brengt.
Config.DelivJobPay = 75 -- Hoeveel iemand wordt betaalt hij naar een adres rijd.

Config.PayDeposit			= true		
Config.VanDepositAmount		= 300		
Config.BikeDepositAmount	= 150		
Config.CarToSpawn			= 'vwcaddy'
Config.BikeToSpawn			= 'nrg'

Config.EnableMoreWorkMorePay	= true	
