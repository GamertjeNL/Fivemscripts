...
m.messages = {   
    'Message ^1Heb je problemen meld het via /report of ga onze discord joinen en ga wachtkamer dan wordt je zo snel mogelijk geholpen',
    '^4Message Wil jij onze discord joinen voor vragen? join: discord.gg/xtm8Scy',
}
