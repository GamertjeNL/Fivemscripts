...
if GetCurrentResourceName() == 'dgrp_mcdonalds' or GetCurrentResourceName() == 'dgrp_mcdonaldsjob' or GetCurrentResourceName() == 'dgrp_mcdonaldsjob-master' then
  print("De McDonalds-baan van William is succesvol geladen")
	...
	ESX.RegisterUsableItem('mcdonalds_drink', function(source)
		...
		xPlayer.showNotification("~b~Je dronk een ~y~McDonalds ~b~ Drink.")
	end)
	...
	ESX.RegisterUsableItem('mcdonalds_fries', function(source)
		...
		xPlayer.showNotification("~b~Je hebt wat gegeten ~y~McDonalds ~b~ Fries.")
	end)
	...
	ESX.RegisterUsableItem('mcdonalds_burger', function(source)
		...
		TriggerClientEvent('esx_basicneeds:onEat', source)
		xPlayer.showNotification("~b~Je at een ~y~McDonalds ~b~ Burger.")
	end)
	...
	ESX.RegisterUsableItem('mcdonalds_meal', function(source)
		...
		TriggerClientEvent('esx_status:add', source, 'thirst', 200000)
		TriggerClientEvent('esx_basicneeds:onEat', source)
		xPlayer.showNotification("~b~Je at en dronk een ~y~McDonalds ~b~Meal.")
	end)
else
    print("\nMaak een screenshot en laat dit zin in discord")
end
